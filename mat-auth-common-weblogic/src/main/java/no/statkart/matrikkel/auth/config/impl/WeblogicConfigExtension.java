 ...
 *
 * Modifisert for å kunne kjøre på WebLogic i ear filer
 *
 * @author <a href="http://jmesnil.net/">Jeff Mesnil</a> (c) 2017 Red Hat inc.
 */
public class WeblogicConfigExtension implements Extension {

    private final Set<InjectionPoint> injectionPoints = new HashSet<>();

    public WeblogicConfigExtension() {
    }
    ...
    public void collectInjectionPoint(@Observes ProcessBean<?> pb) {
